        ...
        <div className="ErreurPage">
            <div className="ErreurPage__container">
                <div className="ErreurPage__container__text">
                    ...
                    <a className="invite_bot_button" href="https://discord.com/api/oauth2/authorize?client_id=1012688780471308339&permissions=1945627743&scope=bot%20applications.commands" >
