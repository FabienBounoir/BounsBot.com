...
export const Login = () => {
    return (
        <div className="container-logo">
            ...
            <a className="boutonConnection" href="https://discord.com/api/oauth2/authorize?client_id=1013448884963516488&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Foauth%2Fcallback&response_type=code&scope=identify%20email%20guilds%20connections">
                ...
                {/* <a className="boutonConnection" href="https://discord.com/api/oauth2/authorize?client_id=1012688780471308339&permissions=8&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Foauth%2Fcallback&response_type=code&scope=identify%20email%20connections%20guilds%20guilds.join" > */}
