                ...
                <div className="block padding-1">
                    ...
                    <div style={{ "display": "flex", "flexDirection": "row-reverse", "gap": "10px", flexWrap: "wrap" }}>
                        <p className="categorie_config">
                            ...
                            {/* ℹ️ Ce lien sera inclus dans l'embed de bannissement lorsque vous utilisez les commandes <b>/ban</b> ou <b>/tempban</b> de Bouns'bot sur votre serveur. Il permettra aux personnes bannies de <u>soumettre une demande de débannissement</u>, améliorant ainsi <b>l'expérience utilisateur</b>. */}
                        </p>
