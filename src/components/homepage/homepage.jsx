...
export const HomePage = () => {
    return (
        <div id="head" class="home__top">
            <div class="home__top__bot">
                <img
                alt="logo"
                src= { logo }
                width="267"
