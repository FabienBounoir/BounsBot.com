...
export const HomePage = () => {
    return (
        <div id="head" className={"home__top" + (new Date().getMonth() === 9 ? " home__halloween" : "")}>
            <div className={"home__top__bot" + (new Date().getMonth() === 9 ? " home__halloween_bottom" : "")}>
                ...
                {(() => {
                    ...
                    if (window.innerWidth > 768) {
                        ...
                        for (let i = 0; i < nbParticule; i++) {
                            ...
                            particulesNano.push(<Avatar classElement="particulesNano" width={size} height={size2} styleElement={{ top, left, transform: `rotate(${rotate})`, animation: `nanoParticuleAnimation ${Math.floor(Math.random() * 8) + 3}s linear infinite` }} />);
                        }
